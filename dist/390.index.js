...
var runnables_base = __webpack_require__(65381);
    ...
    async format(values) {
        ...
        for (const [key, value] of Object.entries(this.template)) {
            if (typeof value === "string") {
                formatted[key] = (0,prompts_template/* renderTemplate */.Xm)(value, this.templateFormat, values);
            }
            else {
                formatted[key] = value;
            }
 ...
 * conversation.
 */
class BaseMessagePromptTemplate extends runnables_base/* Runnable */.YN {
    constructor() {
        super(...arguments);
        Object.defineProperty(this, "lc_namespace", {
            enumerable: true,
    ...
    async formatMessages(values) {
        ...
        try {
            if (Array.isArray(input)) {
                formattedMessages = input.map(utils/* coerceMessageLikeToMessage */.K0);
            }
            else {
                formattedMessages = [(0,utils/* coerceMessageLikeToMessage */.K0)(input)];
            }
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
        }
        catch (e) {
...
class ChatMessagePromptTemplate extends BaseMessageStringPromptTemplate {
    ...
    async format(values) {
        return new chat/* ChatMessage */.cM(await this.prompt.format(values), this.role);
    }
    ...
    static fromTemplate(template, additionalOptions) {
        ...
        for (const item of template) {
            if (typeof item === "string" ||
                ...
                prompt.push(prompts_prompt.PromptTemplate.fromTemplate(text, options));
            }
                ...
                if (typeof imgTemplate === "string") {
                    ...
                    if (additionalOptions?.templateFormat === "mustache") {
                        parsedTemplate = (0,prompts_template/* parseMustache */.g2)(imgTemplate);
                    }
                    else {
                        parsedTemplate = (0,prompts_template/* parseFString */.D4)(imgTemplate);
                    }
                    ...
                    if ("url" in imgTemplate) {
                        let parsedTemplate;
                        if (additionalOptions?.templateFormat === "mustache") {
                            parsedTemplate = (0,prompts_template/* parseMustache */.g2)(imgTemplate.url);
                        }
                        else {
                            parsedTemplate = (0,prompts_template/* parseFString */.D4)(imgTemplate.url);
                        }
...
class SystemMessagePromptTemplate extends _StringImageMessagePromptTemplate {
    static _messageClass() {
        return system/* SystemMessage */.tn;
    }
    static lc_name() {
...
function _coerceMessagePromptTemplateLike(messagePromptTemplateLike, extra) {
    if (_isBaseMessagePromptTemplate(messagePromptTemplateLike) ||
        (0,base/* isBaseMessage */.ny)(messagePromptTemplateLike)) {
    ...
    else if (chat/* ChatMessage */.cM.isInstance(message)) {
    ...
    constructor(input) {
        ...
        if (this.validateTemplate) {
            ...
            for (const promptMessage of this.promptMessages) {
                // eslint-disable-next-line no-instanceof/no-instanceof
                if (promptMessage instanceof base/* BaseMessage */.XQ)
                    continue;
            ...
            if (promptMessage instanceof base/* BaseMessage */.XQ) {
                ...
                const inputValues = promptMessage.inputVariables.reduce((acc, inputVariable) => {
                    if (!(inputVariable in allValues) &&
                        ...
                        const error = (0,errors/* addLangChainErrorFields */.Y)(new Error(`Missing value for input variable \`${inputVariable.toString()}\``), "INVALID_PROMPT_INPUT");
                        throw error;
                    }
...
;
//# sourceMappingURL=390.index.js.map
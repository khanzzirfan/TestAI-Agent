...
__webpack_require__.d(__webpack_exports__, {
  AIMessage: () => (/* reexport */ ai/* AIMessage */.Od),
  AIMessageChunk: () => (/* reexport */ ai/* AIMessageChunk */.H),
  BaseMessage: () => (/* reexport */ base/* BaseMessage */.XQ),
  BaseMessageChunk: () => (/* reexport */ base/* BaseMessageChunk */.gj),
  ChatMessage: () => (/* reexport */ chat/* ChatMessage */.cM),
  ChatMessageChunk: () => (/* reexport */ chat/* ChatMessageChunk */.XU),
  FunctionMessage: () => (/* reexport */ messages_function/* FunctionMessage */.mg),
  FunctionMessageChunk: () => (/* reexport */ messages_function/* FunctionMessageChunk */.FK),
  HumanMessage: () => (/* reexport */ human/* HumanMessage */.xc),
  HumanMessageChunk: () => (/* reexport */ human/* HumanMessageChunk */.a7),
  RemoveMessage: () => (/* reexport */ RemoveMessage),
  SystemMessage: () => (/* reexport */ system/* SystemMessage */.tn),
  SystemMessageChunk: () => (/* reexport */ system/* SystemMessageChunk */.uU),
  ToolMessage: () => (/* reexport */ tool/* ToolMessage */.uf),
  ToolMessageChunk: () => (/* reexport */ tool/* ToolMessageChunk */.dr),
  _isMessageFieldWithRole: () => (/* reexport */ base/* _isMessageFieldWithRole */.dp),
  _mergeDicts: () => (/* reexport */ base/* _mergeDicts */.ns),
  _mergeLists: () => (/* reexport */ base/* _mergeLists */.Vt),
  _mergeObj: () => (/* reexport */ base/* _mergeObj */.F7),
  _mergeStatus: () => (/* reexport */ base/* _mergeStatus */.Iv),
  coerceMessageLikeToMessage: () => (/* reexport */ utils/* coerceMessageLikeToMessage */.K0),
  convertToChunk: () => (/* reexport */ utils/* convertToChunk */.ih),
  defaultTextSplitter: () => (/* reexport */ defaultTextSplitter),
  filterMessages: () => (/* reexport */ filterMessages),
  getBufferString: () => (/* reexport */ utils/* getBufferString */.Sw),
  isAIMessage: () => (/* reexport */ ai/* isAIMessage */.KX),
  isAIMessageChunk: () => (/* reexport */ ai/* isAIMessageChunk */.jm),
  isBaseMessage: () => (/* reexport */ base/* isBaseMessage */.ny),
  isBaseMessageChunk: () => (/* reexport */ base/* isBaseMessageChunk */.AJ),
  isChatMessage: () => (/* reexport */ chat/* isChatMessage */.kY),
  isChatMessageChunk: () => (/* reexport */ chat/* isChatMessageChunk */.bU),
  isFunctionMessage: () => (/* reexport */ messages_function/* isFunctionMessage */.AP),
  isFunctionMessageChunk: () => (/* reexport */ messages_function/* isFunctionMessageChunk */.vl),
  isHumanMessage: () => (/* reexport */ human/* isHumanMessage */.di),
  isHumanMessageChunk: () => (/* reexport */ human/* isHumanMessageChunk */.GZ),
  isOpenAIToolCallArray: () => (/* reexport */ base/* isOpenAIToolCallArray */.Ao),
  isSystemMessage: () => (/* reexport */ system/* isSystemMessage */.X4),
  isSystemMessageChunk: () => (/* reexport */ system/* isSystemMessageChunk */.UF),
  isToolMessage: () => (/* reexport */ tool/* isToolMessage */.wk),
  isToolMessageChunk: () => (/* reexport */ tool/* isToolMessageChunk */.P),
  mapChatMessagesToStoredMessages: () => (/* reexport */ utils/* mapChatMessagesToStoredMessages */.Js),
  mapStoredMessageToChatMessage: () => (/* reexport */ utils/* mapStoredMessageToChatMessage */.Pz),
  mapStoredMessagesToChatMessages: () => (/* reexport */ utils/* mapStoredMessagesToChatMessages */.rf),
  mergeContent: () => (/* reexport */ base/* mergeContent */._I),
  mergeMessageRuns: () => (/* reexport */ mergeMessageRuns),
  trimMessages: () => (/* reexport */ trimMessages)
});
...
function filterMessages(messagesOrOptions, options) {
    ...
    return runnables_base/* RunnableLambda */.jY.from((input) => {
...
function mergeMessageRuns(messages) {
    ...
    return runnables_base/* RunnableLambda */.jY.from(_mergeMessageRuns);
}
function _mergeMessageRuns(messages) {
    ...
    for (const msg of messages) {
        ...
        if (!last) {
            ...
            const lastChunk = (0,utils/* convertToChunk */.ih)(last);
            const currChunk = (0,utils/* convertToChunk */.ih)(curr);
...
function trimMessages(messagesOrOptions, options) {
    if (Array.isArray(messagesOrOptions)) {
        ...
        return runnables_base/* RunnableLambda */.jY.from((input) => _trimMessagesHelper(input, trimmerOptions)).withConfig({
...
async function _lastMaxTokens(messages, options) {
    ...
    let messagesCopy = messages.map((message) => {
        ...
        return _switchTypeToMessage(message.getType(), fields, (0,base/* isBaseMessageChunk */.AJ)(message));
    });
    if (endOn) {
        const endOnArr = Array.isArray(endOn) ? endOn : [endOn];
...
function _switchTypeToMessage(messageType, fields, returnChunk) {
    ...
    switch (messageType) {
        case "human":
            if (returnChunk) {
                chunk = new human/* HumanMessageChunk */.a7(fields);
            }
            else {
                msg = new human/* HumanMessage */.xc(fields);
            }
            break;
        case "ai":
            if (returnChunk) {
                ...
                chunk = new ai/* AIMessageChunk */.H(aiChunkFields);
            }
            else {
                msg = new ai/* AIMessage */.Od(fields);
            }
            break;
        case "system":
            if (returnChunk) {
                chunk = new system/* SystemMessageChunk */.uU(fields);
            }
            else {
                msg = new system/* SystemMessage */.tn(fields);
            }
            break;
        case "developer":
            if (returnChunk) {
                chunk = new system/* SystemMessageChunk */.uU({
                    ...fields,
                    additional_kwargs: {
                ...
                msg = new system/* SystemMessage */.tn({
                    ...fields,
                    additional_kwargs: {
                        ...fields.additional_kwargs,
                        __openai_role__: "developer",
        ...
        case "tool":
            if ("tool_call_id" in fields) {
                if (returnChunk) {
                    chunk = new tool/* ToolMessageChunk */.dr(fields);
                }
                else {
                    msg = new tool/* ToolMessage */.uf(fields);
                }
            }
            else {
        ...
        case "function":
            if (returnChunk) {
                chunk = new messages_function/* FunctionMessageChunk */.FK(fields);
            }
            else {
                if (!fields.name) {
                    throw new Error("FunctionMessage must have a 'name' field");
                }
                msg = new messages_function/* FunctionMessage */.mg(fields);
            }
            break;
        case "generic":
            if ("role" in fields) {
                if (returnChunk) {
                    chunk = new chat/* ChatMessageChunk */.XU(fields);
                }
                else {
                    msg = new chat/* ChatMessage */.cM(fields);
                }
            }
            else {
...
/* harmony export */   GL: () => (/* binding */ MessagesPlaceholder),
/* harmony export */   OT: () => (/* binding */ BaseMessageStringPromptTemplate),
/* harmony export */   RZ: () => (/* binding */ ChatPromptTemplate),
/* harmony export */   Wn: () => (/* binding */ ChatMessagePromptTemplate),
/* harmony export */   pl: () => (/* binding */ BaseMessagePromptTemplate),
/* harmony export */   qF: () => (/* binding */ BaseChatPromptTemplate),
/* harmony export */   sS: () => (/* binding */ AIMessagePromptTemplate)
/* harmony export */ });
/* harmony import */ var _messages_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(91574);
/* harmony import */ var _prompt_values_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(49484);
/* harmony import */ var _runnables_base_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(27918);
/* harmony import */ var _string_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3748);
/* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1776);
/* harmony import */ var _prompt_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(68531);
/* harmony import */ var _image_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(99848);
/* harmony import */ var _template_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(36574);
...
/* harmony export */   s: () => (/* binding */ FewShotChatMessagePromptTemplate)
/* harmony export */ });
...
/* harmony import */ var _prompt_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(68531);
/* harmony import */ var _chat_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(24231);
...
/* harmony import */ var _template_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(36574);
...
;
//# sourceMappingURL=430.index.js.map